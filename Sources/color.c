...
const GE_Color GE_DARK_RED    = { 0x8B, 0x00, 0x00, 0xFF };
const GE_Color GE_DARK_GREEN  = { 0x00, 0x64, 0x00, 0xFF };
const GE_Color GE_DARK_BLUE   = { 0x00, 0x00, 0x8B, 0xFF };

const GE_Color GE_LIGHT_RED   = { 0xFF, 0x72, 0x76, 0xFF };
const GE_Color GE_LIGHT_GREEN = { 0x90, 0xEE, 0x90, 0xFF };
const GE_Color GE_LIGHT_BLUE  = { 0xAD, 0xD8, 0xE6, 0xFF };
